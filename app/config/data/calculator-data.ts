export const CalcData =[
    {id:1, active:false, name:"Алюминий", profile:[1,2,3,4,5,6,7,8,9],
    ...
    {id:2, active:false, name:"Бронза", profile:[1,2,3,4,5,6,7,8,9],
    ...
    {id:3, active:false, name:"Латунь", profile:[1,2,3,4,5,6,7,8,9],
    ...
    {id:4, active:false, name:"Нержавейка", profile:[1,2,3,4,5,6,7,8,9],
    ...
    {id:5, active:false, name:"Олово", profile:[1,2,3,4,5,6,7,8,9],
        group:[{name:"О1", density:7300},
            {name:"О1Пч", density:7300},
        ]},
    {id:6, active:false, name:"Cвинец", profile:[1,2,3,4,5,6,7,8,9],
    ...
    {id:7, active:false, name:"Титан", profile:[1,2,3,4,5,6,7,8,9],
    ...
    {id:8, active:false, name:"Цинк", profile:[1,2,3,4,5,6,7,8,9],
